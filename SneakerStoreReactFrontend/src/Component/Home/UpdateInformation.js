                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style={{borderRadius:'15px'}}>
                        <div class="card-body p-5">
                            <h2 class="text-uppercase text-center mb-5">Update account information</h2>
                            ...
                            <form asp-action="UpdateInformation" asp-controller="Home" method="POST">
                                ...
                                <div class="form-outline mb-4">
                                    <input type="text" id="name" class="form-control form-control-lg" asp-for="Name" value="@Model.Name" required />
                                    <label class="form-label" for="name">Name</label>
                                </div>

                                <div class="form-outline mb-4">
                                    <input type="text" id="phone" class="form-control form-control-lg" asp-for="Phone" value="@Model.Phone" required />
