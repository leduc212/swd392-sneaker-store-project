    ...
    <div class="col-12">
        <div class="row">
            <div class="col-sm-8 m-auto">
                <form class="theme-form theme-form-2 mega-form" asp-action="Update" asp-controller="AdminProduct" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" asp-for="Id" value="@Model.Id" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" asp-for="Name" value="@Model.Name" placeholder="Product Name" required/>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9 row">
                                    {/* @foreach (var size in Model.SizeList)
                                    {
                                        <div class="form-check col-sm-2">
                                            <input class="form-check-input" type="checkbox" value="@size.Id" id="@size.Id"
                                            name="Sizes" @(Model.Sizes.Contains(size.Id) ? "checked='checked'" : "")>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control textarea resize-ta" asp-for="Description" value="@Model.Description" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="number" required min="0" value="@Model.Price" asp-for="Price"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="btn ms-auto theme-bg-color text-white">Update Product</button>
                </form>
            </div>
        </div>
    </div>
